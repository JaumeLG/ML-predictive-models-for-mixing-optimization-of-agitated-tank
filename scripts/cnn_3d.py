...
class cnn(nn.Module):
    def __init__(self):
        ...
        self.cnv1=nn.Conv3d(5,32,3,1,padding=1)
        self.cnv2=nn.Conv3d(32,64,3,1,padding=1)
        self.cnv3=nn.Conv3d(64,128,5,1,padding=2)
        self.cnv4=nn.Conv3d(128,256,5,1,padding=2)
        self.cnv7=nn.ConvTranspose3d(256,128,5,1,padding=2)
        self.cnv8=nn.ConvTranspose3d(128,64,5,1,padding=1)
        self.cnv9=nn.ConvTranspose3d(64,32,2,1,padding=1)
        self.cnv10=nn.ConvTranspose3d(32,3,1,1,padding=1)
...
print('Saving model')
torch.save(model.state_dict(), './results/models/model_CNN_3d.pth')
...
plt.legend()
plt.savefig('./results/plots/training_losses_CNN_3d.png')
plt.close()
...
np.savez('./results/preds/preds_CNN_3d.npz',ypred_sc)
