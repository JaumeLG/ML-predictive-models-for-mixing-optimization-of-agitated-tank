...
dataset=TensorDataset(outputs_sc,outputs_sc)
...
print('Saving model')
torch.save(model.state_dict(), './results/models/model_pca_ae_3d.pth')
...
plt.legend()
plt.savefig('./results/plots/training_losses_pca_ae_3d.png')
plt.close()
#plt.show()
...
np.savez('./results/preds/preds_pca_ae_3d.npz',velPred)
