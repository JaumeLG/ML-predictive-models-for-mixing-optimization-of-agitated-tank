...
class hybridModel(nn.Module):
    def __init__(self):
        ...
        self.fc5=nn.Linear(512,5184)

        self.drop1=nn.Dropout(0.2)
        self.drop2=nn.Dropout(0.3)

        self.cnv1=nn.Conv3d(3,512,3,1,padding=1)
        self.up1=nn.ConvTranspose3d(512,512,3,(2,2,2),padding=1)
        self.cnv2=nn.Conv3d(512,256,3,1,padding=1)
        self.up2=nn.ConvTranspose3d(256,256,3,(2,2,2))
        self.cnv3=nn.Conv3d(256,128,3,1,padding=1,padding_mode='replicate')
        self.cnv4=nn.Conv3d(128,64,3,1,padding=1,padding_mode='replicate')
        self.cnv5=nn.Conv3d(64,32,3,1,padding=1,padding_mode='replicate')
        self.cnv6=nn.Conv3d(32,3,1,1)
...
print('Saving model')
torch.save(model.state_dict(), './results/models/model_Hybrid_3d.pth')
...
plt.legend()
plt.savefig('./results/plots/training_losses_Hybrid_3d.png')
plt.close()
...
np.savez('./results/preds/preds_Hybrid_3d.npz',ypred_sc)
np.savez('./results/preds/true_3d.npz',ytrue_sc)
